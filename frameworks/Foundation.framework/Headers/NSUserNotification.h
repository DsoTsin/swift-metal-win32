...
typedef NS_ENUM(NSInteger, NSUserNotificationActivationType) {
  ...
  } API_DEPRECATED("All NSUserNotifications API should be replaced with UserNotifications.frameworks API", macos(10.8, 10.16)) API_UNAVAILABLE(ios, watchos, tvos);
...
API_DEPRECATED("All NSUserNotifications API should be replaced with UserNotifications.frameworks API", macos(10.10, 10.16)) API_UNAVAILABLE(ios, watchos, tvos)
...
FOUNDATION_EXPORT NSString * const NSUserNotificationDefaultSoundName API_DEPRECATED("All NSUserNotifications API should be replaced with UserNotifications.frameworks API", macos(10.8, 10.16)) API_UNAVAILABLE(ios, watchos, tvos);
...
- (void)userNotificationCenter:(NSUserNotificationCenter *)center didDeliverNotification:(NSUserNotification *)notification API_DEPRECATED("All NSUserNotifications API should be replaced with UserNotifications.frameworks API", macos(10.8, 10.16)) API_UNAVAILABLE(ios, watchos, tvos);
...
- (void)userNotificationCenter:(NSUserNotificationCenter *)center didActivateNotification:(NSUserNotification *)notification API_DEPRECATED("All NSUserNotifications API should be replaced with UserNotifications.frameworks API", macos(10.8, 10.16)) API_UNAVAILABLE(ios, watchos, tvos);
...
- (BOOL)userNotificationCenter:(NSUserNotificationCenter *)center shouldPresentNotification:(NSUserNotification *)notification API_DEPRECATED("All NSUserNotifications API should be replaced with UserNotifications.frameworks API", macos(10.8, 10.16)) API_UNAVAILABLE(ios, watchos, tvos);
