...
typedef NS_ENUM(NSUInteger, MTLDataType) {
    ...
    MTLDataTypeVisibleFunctionTable API_AVAILABLE(macos(10.16), ios(14.0)) = 115,
    MTLDataTypeIntersectionFunctionTable API_AVAILABLE(macos(10.16), ios(14.0)) = 116,
    MTLDataTypePrimitiveAccelerationStructure API_AVAILABLE(macos(10.16), ios(14.0)) = 117,
    MTLDataTypeInstanceAccelerationStructure API_AVAILABLE(macos(10.16), ios(14.0)) = 118,
...
typedef NS_ENUM(NSUInteger, MTLArgumentType) {
    ...
    MTLArgumentTypeVisibleFunctionTable API_AVAILABLE(macos(10.16), ios(14.0)) = 24,
    MTLArgumentTypePrimitiveAccelerationStructure API_AVAILABLE(macos(10.16), ios(14.0)) = 25,
    MTLArgumentTypeInstanceAccelerationStructure API_AVAILABLE(macos(10.16), ios(14.0)) = 26,
    MTLArgumentTypeIntersectionFunctionTable API_AVAILABLE(macos(10.16), ios(14.0)) = 27,
} API_AVAILABLE(macos(10.11), ios(8.0));
