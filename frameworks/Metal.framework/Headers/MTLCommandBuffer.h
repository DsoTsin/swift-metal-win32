...
*/
@property (readonly) MTLCommandBufferErrorOption errorOptions API_AVAILABLE(macos(10.16), ios(14.0));
...
*/
@property (readonly) id<MTLLogContainer> logs API_AVAILABLE(macos(10.16), ios(14.0));
 ...
 */
- (nullable id <MTLComputeCommandEncoder>)computeCommandEncoderWithDescriptor:(MTLComputePassDescriptor *)computePassDescriptor API_AVAILABLE(macos(10.16), ios(14.0));

/*!
 @method blitCommandEncoderWithDescriptor:
 @abstract returns a blit command endcoder to encode into this command buffer.
 */
- (nullable id <MTLBlitCommandEncoder>)blitCommandEncoderWithDescriptor:(MTLBlitPassDescriptor *)blitPassDescriptor API_AVAILABLE(macos(10.16), ios(14.0));
/*!
...
- (nullable id <MTLAccelerationStructureCommandEncoder>)accelerationStructureCommandEncoder API_AVAILABLE(macos(10.16), ios(14.0));
