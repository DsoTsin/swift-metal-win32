...
typedef NS_OPTIONS(NSUInteger, MTLPipelineOption)
{
    ...
    MTLPipelineOptionFailOnBinaryArchiveMiss API_AVAILABLE(macos(10.16), ios(14.0)) = 1 << 2,
...
/*!
@enum MTLRoundingMode
@abstract MTLRoundingMode determines the mode used when converting floating point values from higher precision to lower precision.
*/
typedef NS_ENUM(NSInteger, MTLRoundingMode)
{
    MTLRoundingModeDefault  = 0,    // Represents either RTZ or RTNE based on a particular GPU family support
    MTLRoundingModeRTZ      = 1,    // Round-to-zero
    MTLRoundingModeRTNE     = 2,    // Round-to-nearest-even
 ...
 */
@property(readonly) BOOL supportsPullModelInterpolation API_AVAILABLE(macos(10.16),ios(14.0));
...
*/
- (BOOL)supportsCounterSampling:(MTLCounterSamplingPoint)samplingPoint API_AVAILABLE(macos(10.16), ios(14.0));
 ...
 */
@property(readonly) BOOL supportsDynamicLibraries API_AVAILABLE(macos(10.16), ios(14.0));
 ...
 */
- (nullable id<MTLDynamicLibrary>) newDynamicLibrary:(id<MTLLibrary>)library error:(NSError **) error API_AVAILABLE(macos(10.16), ios(14.0));
 ...
 */
- (nullable id<MTLDynamicLibrary>) newDynamicLibraryWithURL:(NSURL *)url error:(NSError **) error API_AVAILABLE(macos(10.16), ios(14.0));
/*!
...
- (nullable id<MTLBinaryArchive>) newBinaryArchiveWithDescriptor:(MTLBinaryArchiveDescriptor*)descriptor
                                                           error:(NSError**)error API_AVAILABLE(macos(10.16), ios(14.0));

@property (readonly) BOOL supportsRaytracing API_AVAILABLE(macos(10.16), ios(14.0));

- (MTLAccelerationStructureSizes)accelerationStructureSizesWithDescriptor:(MTLAccelerationStructureDescriptor *)descriptor API_AVAILABLE(macos(10.16), ios(14.0));

- (nullable id <MTLAccelerationStructure>)newAccelerationStructureWithSize:(NSUInteger)size API_AVAILABLE(macos(10.16), ios(14.0));
- (nullable id <MTLAccelerationStructure>)newAccelerationStructureWithDescriptor:(MTLAccelerationStructureDescriptor *)descriptor API_AVAILABLE(macos(10.16), ios(14.0));

@property (readonly) BOOL supportsFunctionPointers API_AVAILABLE(macos(10.16), ios(14.0));
@property (readonly) BOOL supportsBinaryFunctionPointers API_AVAILABLE(macos(10.16), ios(14.0));
